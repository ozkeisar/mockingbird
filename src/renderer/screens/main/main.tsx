import { Details, SideBar, TopBar } from "../../components";
import './main.css';
...
import { ParentDialog } from "../../components";
...
export const Main = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<MainSideBarTabs | null>('routes')
  ...
  const handleAddEditParent = ({data, serverName}:{data: RouteParent | null, serverName: string})=>{
    ...
    <>
      <div className='main-container'>
        <TopBar />
        {
          ...
          ? <CloneProject />
          : <div className='body'>
              <MainSideBar selectedTab={selectedTab} onSelectedTab={(val)=>setSelectedTab(prev=>prev === val ? null : val)}/>
              <div className="body-content-wrapper">
                <div className="body-content">
                  ...
                  >
                      ...
                      <div className="app-sidebar-resizer" onMouseDown={startSideBarResizing} />
                  </div>
                ...
                >
                  <div className="console-resizer" onMouseDown={startConsoleResizing} />
                  <DevTools
