...
export function PresetFolderDetails() {
  ...
  const [isPresetFolderDialogOpen, setIsPresetFolderDialogOpen] =
    useState(false);
  const [isDeletePresetFolderDialogOpen, setIsDeletePresetFolderDialogOpen] =
    useState(false);
  ...
  const renderRow = (preset: Preset, _presetFolder: PresetsFolder) => {
              ...
              >
                <span>
                  <LoadingButton
                    ...
                    onClick={(e) => {
                      reportButtonClick(
                        BUTTONS.PRESET_FOLDER_DETAILS_PRESET_ROW_APPLY,
                      );
                      e.stopPropagation();
  ...
  return (
    <>
      ...
      {isDeletePresetFolderDialogOpen && presetFolder && (
        <DeletePresetFolderDialog
          open
          onClose={() => {
