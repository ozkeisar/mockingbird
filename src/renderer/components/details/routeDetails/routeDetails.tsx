...
import { emitSocketEvent, getRouteBGColor, openInNewTab, reportButtonClick, socket } from "../../../utils";
import cloneDeep from "lodash/cloneDeep";
import { useProjectStore } from "../../../state/project";
import { useResponseActions, useRouteActions } from "../../../hooks/files";
import { useSelectedRestRoute } from "../../../hooks";
import { DeleteResponseDialog, DeleteRouteDialog, ResponseDialog, RouteDialog } from "../../dialogs";
...
export const RouteDetails = ()=>{
    ...
    const [editResponseData, setEditResponseData] = useState<RouteResponse | null>(null);
    ...
    }
    {
        ...
        {
        isResponseDialogOpen && !!parent && !!route && !!server && <ResponseDialog 
