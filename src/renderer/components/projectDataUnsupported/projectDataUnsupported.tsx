...
export const ProjectDataUnsupported = ({open, onClose, projectName}: {projectName: string, open: boolean, onClose: ()=>void})=>{
    const handleClose = ()=>{
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            {projectName} project data has been used in a newer version of Mockingbird,
          </DialogContentText>
          <DialogContentText id="alert-dialog-description">
