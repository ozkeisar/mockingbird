  ...
  return (
    <div className={styles.container}>
      <div className={styles.left}>
        {isGitInit && activeProjectName && (
          <div className={styles.gitBtn} onClick={handleBranchNameClicked}>
            <GitIcon className={styles.gitIcon} />
            <Typography variant="subtitle2" className={styles.branchName}>
              {currentBranch}
            </Typography>
          </div>
        )}
      ...
      <div>
        <Typography className={styles.version} variant="subtitle2">
          v{pjson.version}
        </Typography>
      </div>
      {isBranchDialogOpen && (
