...
export const AddRemoteDialog = ({open, onClose}: {open: boolean, onClose: ()=>void})=>{
  ...
  useEffect(()=>{
    ...
    const handleActivate = ()=>{
      ...
      setIsLoading(true)
      emitSocketEvent(EVENT_KEYS.ADD_REMOTE, { remoteUrl, projectName: activeProjectName });
    }
      ...
      >
        ...
        <DialogContent style={{minWidth:'450px'}}>
          ...
          <TextField 
            ...
            label="remote url" 
            variant='filled' />
         {isInvalidCode && <Typography color={'error'}>Invalid remote url</Typography>}
