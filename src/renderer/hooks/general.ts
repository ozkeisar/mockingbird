...
import { GraphQlRoute, Preset, PresetsFolder, ProjectData, ProjectServer, Route, RouteParent } from "../../types";
...
export const useSelectedRestRoute = ():{parent?: RouteParent, route?: Route, server?: ProjectServer}=>{
...
export const useSelectedGraphQlRoute = ()=>{
  ...
  if(parent?.type === 'GraphQl' && parent.graphQlRouteHash && selectedRouteId){
...
export const useSelectedRoute = ():{parent?: RouteParent, route?: Route | GraphQlRoute, server?: ProjectServer}=>{
...
export const useSelectedPreset = ():{presetFolder: PresetsFolder | null, preset: Preset| null}=>{
...
export const useResizeElement = ({baseline, initSize}:{baseline:'bottom' | 'left', initSize: number})=>{
